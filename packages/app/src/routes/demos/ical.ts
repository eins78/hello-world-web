        ...
        <div class="col-md-6">
          <form id="ical-form" class="mb-4">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="duration" name="duration" min="1" required value="60" />
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="datetime-local" class="form-control" id="cancelAt" name="cancelAt" />
